...
class OneGenerateTransformerKnapsack (nn.Module):
    def __init__(
        self,
        config,
        generate_link_number: int,
    ...
    def generateOneStep (
        ...
        generate = self.forward(external_obs, internal_obs, tgt_mask,
                                decoder_padding_mask, step)
    
        return generate, promp_tensor
